...
namespace Charlotte.GameCommons
{
	public static class DDDerivations
	{
		...
		public static IEnumerable<DDPicture> GetAnimation(DDPicture parentPicture, int x, int y, int w, int h, int xNum, int yNum)
		{
			return GetAnimation(parentPicture, x, y, w, h, xNum, yNum, w, h);
		}

		public static IEnumerable<DDPicture> GetAnimation(DDPicture parentPicture, int x, int y, int w, int h, int xNum, int yNum, int xStep, int yStep)
		{
